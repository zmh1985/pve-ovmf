...
sed -i 's/BASE_NAME                 = XenBusDxe/BASE_NAME                 = AsusBusDxe/g' OvmfPkg/XenBusDxe/XenBusDxe.inf
...
sed -i 's/BASE_NAME                 = XenPvBlkDxe/BASE_NAME                 = AsusPvBlkDxe/g' OvmfPkg/XenPvBlkDxe/XenPvBlkDxe.inf
